...
module.exports = {
  siteMetadata: {
    title: `Samarth Ganorkar Portfolio`,
    titleTemplate: `%s | Samarth Ganorkar Portfolio`,
    ...
    author: `@SamarthGanorkar`,
    url: "https://pantak.net",
    image: "/Cartoonized_Image.jpg", // Path to your image you placed in the 'static' folder
    twitterUsername: "@SamarthGanorkar",
  },
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        name: `Samarth Ganorkar Portfolio`,
        short_name: `Samarth Ganorkar Portfolio`,
        start_url: `/`,
        background_color: `#1b2d3a`,
        theme_color: `#1b2d3a`,
        display: `minimal-ui`,
        icon: `src/images/Cartoonized_Image.jpg`, // This path is relative to the root of the site.
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
